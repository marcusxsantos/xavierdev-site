...
const translations = {
  'pt': {
    ...
    hero: {
      ...
      subtitle: 'Soluções inteligentes em TI com Inteligência Artificial, hospedagem web, tratamento de dados e desenvolvimento de aplicações desde 2017.',
      cta: 'Fale Conosco',
    ...
    about: {
      ...
      description2: 'Estabelecida em 2017 no Rio de Janeiro, temos o compromisso de entregar excelência em cada projeto, combinando expertise técnica com atendimento personalizado.',
      features: [
        { title: 'Experiência', desc: 'Desde 2017 no mercado de TI' },
  ...
  'en': {
    ...
    hero: {
      ...
      subtitle: 'Intelligent IT solutions with Artificial Intelligence, web hosting, data processing, and application development since 2017.',
      cta: 'Get in Touch',
    ...
    about: {
      ...
      description2: 'Established in 2017 in Rio de Janeiro, we are committed to delivering excellence in every project, combining technical expertise with personalized service.',
      features: [
        { title: 'Experience', desc: 'Since 2017 in the IT market' },
  ...
  'es': {
    ...
    hero: {
      ...
      titleHighlight: 'Transforma',
      subtitle: 'Soluciones inteligentes de TI con Inteligencia Artificial, alojamiento web, tratamiento de datos y desarrollo de aplicaciones desde 2017.',
      cta: 'Contáctenos',
    ...
    about: {
      ...
      description2: 'Establecida en 2017 en Río de Janeiro, tenemos el compromiso de entregar excelencia en cada proyecto, combinando experiencia técnica con atención personalizada.',
      features: [
        { title: 'Experiencia', desc: 'Desde 2017 en el mercado de TI' },
